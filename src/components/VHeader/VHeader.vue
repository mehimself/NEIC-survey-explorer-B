  ...
  <div>
    ...
    >
      <v-toolbar-title style="width: 300px" class="ml-0 pl-3">
        ...
        <span class="hidden-sm-and-down">Survey Explorer</span>
      </v-toolbar-title>
      <v-spacer></v-spacer>
      <!--v-btn
        icon
  ...
  export default {
    ...
    data: () => ({
      ...
      items: [
        ...
        {icon: 'info_outline', link: 'news', text: 'News'},
        {
          loginRequired: true,
          ...
          model: false,
          children: [
            {icon: 'highlight', link: 'rxe', text: 'Regular Expression Explorer'},
            {icon: 'explore', link: 'EDO', text: 'Explorative Document Operator'},
            {icon: 'backup', link: 'AppGen', text: 'Application Generator'},
            {icon: 'code', link: 'CodeBoost', text: 'Code Boost'}
          ]
        },
        // {icon: 'storage', link: 'repositories', text: 'Data Repositories'},
        {icon: 'group', link: 'team', text: 'Team'},
    ...
    methods: {
      ...
      login(payload) {
        ...
        payload.requestOptions = {
          ...
          redirectUri: 'http://datakuben.sdu.dk/auth/callback',
